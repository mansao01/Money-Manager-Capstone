...
class MoneyDiffCallback(
    private val mOldNoteList: List<Money>,
    private val mNewNoteList: List<Money>
) : DiffUtil.Callback() {
    ...
    override fun areContentsTheSame(oldItemPosition: Int, newItemPosition: Int): Boolean {
        ...
        return oldEmployee.titleMoney == newEmployee.titleMoney && oldEmployee.descMoney == newEmployee.descMoney
    }
}